...
#netgraph(m.netmeta, 
#         labels = long.labels, number.of.studies = TRUE,  srt.labels = 0, points=FALSE
#         )

netgraph(m.netmeta, 
         labels = long.labels, number.of.studies = TRUE,  srt.labels = 0,  lwd.max=13
         )

# lwd.max setting the line thickness  
