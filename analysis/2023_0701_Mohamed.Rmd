...
variable="live demo"
combine_data_2=combine_data %>% filter(Q4==variable) %>% mutate(total_n=c(sum(data_2022A_plot2$n), sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
