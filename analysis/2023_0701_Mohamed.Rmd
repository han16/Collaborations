...
```{r, echo=F, message=F, warning=F}
grades=read_excel("C:\\Shengtong\\Research\\AllCollaboration\\2023\\202307\\Mohamed\\grades all years.xlsx")
live_demo=data.frame(yearr2020=as.numeric(grades[3:108,5]%>%pull()), year2021=as.numeric(grades[3:108,10]%>%pull()), year2022=as.numeric(grades[3:108,15]%>%pull()), year2023=as.numeric(grades[3:108,20]%>%pull()), year2024=as.numeric(grades[3:108,25]%>%pull()))
