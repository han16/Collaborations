...
data_2024=read_excel("C:\\Shengtong\\Research\\AllCollaboration\\2023\\202307\\Mohamed\\Endo Lab Learning Preference - 2024(1-99).xlsx")
```


```{r, echo=F, message=F, warning=F}
# change years 2021 to 2020
# 2022A  to 2021
# 2022B  to 2022

data.frame(year=c("2020", "2021", "2022", "2023", "2024"), num_participants=c(nrow(data_2021), nrow(data_2022A), nrow(data_2022B), nrow(data_2023), nrow(data_2024)))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
* look at the first choice in the ranking 
...
```{r, echo=F, message=F, warning=F}
colnames(data_2024)[6]="Q1"
data_2024$Q1=tolower(data_2024$Q1)
data_2024_plot=data_2024 %>% dplyr::count(Q1)%>% mutate(prop=round(n/nrow(data_2024),4)) 

data_2024_plot=data_2024_plot%>% mutate(Response=paste("Res", seq(1:nrow(data_2024_plot)), sep="_"))

  
g1=ggplot(data_2024_plot, aes(x=Response, y=prop, fill=Response)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
  ylab("%")+ylim(c(0,1))+
    xlab("")+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(data_2024_plot, aes(x=Response, y=n, fill=Response)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
  ylab("count")+
    xlab("")+
...
```{r, echo=F, message=F, warning=F}
# sapply(strsplit(data_2021$Q1, ";"), "[", 1)   ## extract the most favoriate one 
data_2024_plot2=data.frame(Q1=sapply(strsplit(data_2024$Q1, ";"), "[", 1)) %>% dplyr::count(Q1)%>% mutate(prop=round(n/nrow(data_2024),4)) 

g1=ggplot(data_2024_plot2, aes(x=Q1, y=prop, fill=Q1)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
  theme(axis.text.x = element_blank())+
  ylab("%")+ylim(c(0,1))+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(data_2024_plot2, aes(x=Q1, y=n, fill=Q1)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
    theme(axis.text.x = element_blank())+
  ylab("count")+
...
Q1_all_response=unique(c(unique(data_2021$Q1), unique(data_2022A$Q1), unique(data_2022B$Q1), unique(data_2023$Q1), unique(data_2024$Q1)))
...
data_2024_plot_full_response=full_join(data_2024_plot, all_response_data) %>% select(Q1, n ,prop) %>% replace(is.na(.), 0) # replace NAs with 0

combine_data=data.frame(Q1=c(
data_2021_plot_full_response$Q1, 
data_2022A_plot_full_response$Q1, 
data_2022B_plot_full_response$Q1, 
data_2023_plot_full_response$Q1, 
data_2024_plot_full_response$Q1),
n=c(data_2021_plot_full_response$n, 
    data_2022A_plot_full_response$n, 
    data_2022B_plot_full_response$n, 
    data_2023_plot_full_response$n, 
    data_2024_plot_full_response$n), 
prop=c(data_2021_plot_full_response$prop, 
       data_2022A_plot_full_response$prop, 
       data_2022B_plot_full_response$prop, 
       data_2023_plot_full_response$prop, 
       data_2024_plot_full_response$prop), 
year=rep(c("2021", "2022A", "2022B", "2023", "2024"), each=23) )
...
```{r, echo=F, message=F, warning=F}
combine_data=data.frame(Q1=c(data_2021_plot2$Q1, 
                             data_2022A_plot2$Q1, 
                             data_2022B_plot2$Q1,         
                             data_2023_plot2$Q1, 
                             data_2024_plot2$Q1),
                        n=c(data_2021_plot2$n, 
                            data_2022A_plot2$n, 
                            data_2022B_plot2$n, 
                            data_2023_plot2$n, 
                            data_2024_plot2$n), 
                        prop=c(data_2021_plot2$prop, 
                               data_2022A_plot2$prop, 
                               data_2022B_plot2$prop, 
                               data_2023_plot2$prop, 
                               data_2024_plot2$prop), year=rep(c("2020", "2021", "2022", "2023", "2024"), 
                                                               each=nrow(data_2021_plot2)))
...
geom_bar(position = "dodge",stat="identity")+
  ...
  #geom_signif(annotations ="p<0.0001", y_position = 0.82  ,xmin=1, xmax=1.9, size=1, vjust=-0.5, textsize=3.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   #geom_signif(annotations ="p=0.0136", y_position = 0.82  ,xmin=2.1, xmax=2.9, size=1, vjust=-0.5, textsize=3.5, color="red")+# textsize is for text over the bar; size is for width of lines 
  #geom_signif(annotations ="p=0.2206", y_position = 0.82  ,xmin=3.1, xmax=3.9, size=1, vjust=-0.5, textsize=3.5, color="black")+
  ...
  #geom_signif(annotations ="p=1.0000", y_position = 1.03  ,xmin=1, xmax=5, size=1, vjust=-0.5, textsize=3.5, color="black")+
...
######## 2022A vs 2022B
#res <- prop.test(x = c(data_2022A_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull, data_2022B_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull), n = c(nrow(data_2022A), nrow(data_2022B))) # use two sample proportion test 
#res$p.value

######## 2022B vs 2023
#res <- prop.test(x = c(data_2022B_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull, data_2023_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull), n = c(nrow(data_2022B), nrow(data_2023))) # use two sample proportion test 
#res$p.value
...
######## 2021 vs 2024
#res <- prop.test(x = c(data_2021_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull, data_2024_plot2%>% filter(Q1=="live demo") %>% select(n) %>% pull), n = c(nrow(data_2021), nrow(data_2024))) # use two sample proportion test 
#res$p.value
variable="live demo"
combine_data_2=combine_data %>% filter(Q1==variable) %>% mutate(total_n=c(sum(data_2021_plot2$n), sum(data_2022A_plot2$n), sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
  {
    k=k+1
    res <- prop.test(x = c(combine_data_2$n[i], combine_data_2$n[j]), n = c(combine_data_2$total_n[i], combine_data_2$total_n[j]))
    pvalue[k]=pvalue_adjust(res$p.value)
    year1[k]=combine_data_2$year[i]; year2[k]=combine_data_2$year[j]
    
  }
data.frame(year=paste(year1, year2, sep="_vs_"), pvalue=pvalue)%>%
datatable(extensions = 'Buttons',
          caption = "", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
```{r, echo=F, message=F, warning=F}
# sapply(strsplit(data_2021$Q1, ";"), "[", 1)   ## extract the most favoriate one 
data_2023_plot2=data.frame(Q2=sapply(strsplit(data_2023$Q2, ";"), "[", 1)) %>% dplyr::count(Q2)%>% mutate(prop=round(n/nrow(data_2023),4)) 
...
```{r, echo=F, message=F, warning=F}
colnames(data_2024)[7]="Q2"
data_2024$Q2=tolower(data_2024$Q2) # unify the response all into lower case 
data_2024_plot=data_2024 %>% dplyr::count(Q2)%>% mutate(prop=round(n/nrow(data_2024),4)) 
...
```{r, echo=F, message=F, warning=F}
# sapply(strsplit(data_2021$Q1, ";"), "[", 1)   ## extract the most favoriate one 
data_2024_plot2=data.frame(Q2=sapply(strsplit(data_2024$Q2, ";"), "[", 1)) %>% dplyr::count(Q2)%>% mutate(prop=round(n/nrow(data_2024),4)) 

g1=ggplot(data_2024_plot2, aes(x=Q2, y=prop, fill=Q2)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
  theme(axis.text.x = element_blank())+
  ylab("%")+ylim(c(0,1))+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(data_2024_plot2, aes(x=Q2, y=n, fill=Q2)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
    theme(axis.text.x = element_blank())+
  ylab("count")+
...
```{r, echo=F, message=F, warning=F}
Q2_all_response=unique(c(unique(data_2021$Q2), 
                         unique(data_2022A$Q2), 
                         unique(data_2022B$Q2), 
                         unique(data_2023$Q2), 
                         unique(data_2024$Q2)))
...
data_2024_plot_full_response=full_join(data_2024_plot, all_response_data) %>% select(Q2, n ,prop) %>% replace(is.na(.), 0) # replace NAs with 0

combine_data=data.frame(Q2=c(data_2021_plot_full_response$Q2,
                             data_2022A_plot_full_response$Q2,
                             data_2022B_plot_full_response$Q2,
                      data_2023_plot_full_response$Q2, 
                      data_2024_plot_full_response$Q2),
                      n=c(data_2021_plot_full_response$n,
                          data_2022A_plot_full_response$n,
                          data_2022B_plot_full_response$n,
                          data_2023_plot_full_response$n, 
                      ...
                      prop=c(data_2021_plot_full_response$prop, 
                             ...
                             data_2023_plot_full_response$prop, 
                             data_2024_plot_full_response$prop), 
                      year=rep(c("2020", "2021", "2022", "2023", "2024"), each=length(Q2_all_response)) )
...
```{r, echo=F, message=F, warning=F}
combine_data=data.frame(Q2=c(data_2021_plot2$Q2, 
                             data_2022A_plot2$Q2, 
                             data_2022B_plot2$Q2,
                             data_2023_plot2$Q2, 
                             data_2024_plot2$Q2),
                        ...
                        prop=c(data_2021_plot2$prop, 
                               ...
                               data_2022B_plot2$prop, 
                               data_2023_plot2$prop, 
                               data_2024_plot2$prop), 
                        year=rep(c("2020", "2021", "2022", "2023", "2024"), each=nrow(data_2021_plot2)))
...
geom_bar(position = "dodge",stat="identity")+
   ...
   geom_text(aes(label=prop*100), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
  #geom_signif(annotations ="p=0.832", y_position = 0.82  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=3.5, color="black")+ # textsize is for text over the bar; size is for width of lines 
   #geom_signif(annotations ="p=1.000", y_position = 0.89  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=3.5, color="black")+
  #geom_signif(annotations ="p=0.242", y_position = 0.96  ,xmin=1, xmax=4, size=1, vjust=-0.5, textsize=3.5, color="black")+
  #geom_signif(annotations ="p=0.293", y_position = 1.03  ,xmin=1, xmax=5, size=1, vjust=-0.5, textsize=3.5, color="black")+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())+
  theme(legend.position = "none")
...
######## 2021 vs 2024
#res <- prop.test(x = c(data_2021_plot2%>% filter(Q2=="demo with instructor speaking throughout the video") %>% select(n) %>% pull, data_2024_plot2%>% filter(Q2=="demo with instructor speaking throughout the video") %>% select(n) %>% pull), n = c(nrow(data_2021), nrow(data_2024))) # use two sample proportion test 
#res$p.value


variable="demo with instructor speaking throughout the video"
combine_data_2=combine_data %>% filter(Q2==variable) %>% mutate(total_n=c(sum(data_2021_plot2$n), sum(data_2022A_plot2$n), sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
...
```{r, echo=F, message=F, warning=F}
colnames(data_2024)[8]="Q3"
data_2024$Q3=tolower(data_2024$Q3) # unify the response all into lower case
data_2024_plot=data_2024 %>% dplyr::count(Q3)%>% mutate(prop=round(n/nrow(data_2024),4)) 
...
data_2024_plot2=data.frame(Q3=sapply(strsplit(data_2024$Q3, ";"), "[", 1)) %>% dplyr::count(Q3)%>% mutate(prop=round(n/nrow(data_2024),4)) 

data_2024_plot2_regroup=data.frame(Q3=c("classical", "country", "pop", "rap", "mix", "other"), n=c(data_2024_plot2%>%filter(Q3=="classical") %>% select(n) %>% pull(), 
                                                                                      data_2024_plot2%>%filter(Q3=="country") %>% select(n) %>% pull(), 
                                                                                        data_2024_plot2%>%filter(Q3=="pop") %>% select(n) %>% pull(), 
                                                                                        data_2024_plot2%>%filter(Q3=="rap") %>% select(n) %>% pull(), 
                                                                                        data_2024_plot2%>%filter(Q3=="mix") %>% select(n) %>% pull(), nrow(data_2024)-sum(c(data_2024_plot2%>%filter(Q3=="classical") %>% select(n) %>% pull(), data_2024_plot2%>%filter(Q3=="country") %>% select(n) %>% pull(), 
                                                                                                                      data_2024_plot2%>%filter(Q3=="pop") %>% select(n) %>% pull(), 
                                                                                                                      data_2024_plot2%>%filter(Q3=="rap") %>% select(n) %>% pull(), 
                                                                                                                      data_2024_plot2%>%filter(Q3=="mix") %>% select(n) %>% pull()))), 
prop=c(data_2024_plot2%>%filter(Q3=="classical") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="country") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="pop") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="rap") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="mix") %>% select(n) %>% pull(), nrow(data_2024)-sum(c(data_2024_plot2%>%filter(Q3=="classical") %>% select(n) %>% pull(), data_2024_plot2%>%filter(Q3=="country") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="pop") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="rap") %>% select(n) %>% pull(), 
data_2024_plot2%>%filter(Q3=="mix") %>% select(n) %>% pull())))/nrow(data_2024))

g1=ggplot(data_2024_plot2_regroup, aes(x=Q3, y=prop, fill=Q3)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
  theme(axis.text.x = element_blank())+
  ylab("%")+ylim(c(0,1))+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(data_2024_plot2_regroup, aes(x=Q3, y=n, fill=Q3)) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  #theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=8))+
    theme(axis.text.x = element_blank())+
  ylab("count")+
...
```{r, echo=F, message=F, warning=F}
Q3_all_response=unique(c(unique(data_2021$Q3), unique(data_2022A$Q3), unique(data_2022B$Q3), unique(data_2023$Q3), unique(data_2024$Q3)))
...
data_2024_plot_full_response=full_join(data_2024_plot, all_response_data) %>% select(Q3, n ,prop) %>% replace(is.na(.), 0) # replace NAs with 0

combine_data=data.frame(Q3=c(data_2021_plot_full_response$Q3, 
                             data_2022A_plot_full_response$Q3, 
                             data_2022B_plot_full_response$Q3,
                             data_2023_plot_full_response$Q3, 
                             data_2024_plot_full_response$Q3),
                        n=c(data_2021_plot_full_response$n, 
                            data_2022A_plot_full_response$n, 
                            data_2022B_plot_full_response$n, 
                            data_2023_plot_full_response$n, 
                        ...
                        prop=c(data_2021_plot_full_response$prop, 
                               ...
                               data_2022B_plot_full_response$prop, 
                               data_2023_plot_full_response$prop, 
                               data_2023_plot_full_response$prop), year=rep(c("2020", "2021", "2022", "2023", "2024"), each=length(Q3_all_response)) )
...
```{r, echo=F, message=F, warning=F}
combine_data=data.frame(Q3=c(data_2021_plot2_regroup$Q3, 
                             data_2022A_plot2_regroup$Q3, 
                             data_2022B_plot2_regroup$Q3,
                             data_2023_plot2_regroup$Q3, 
                             data_2024_plot2_regroup$Q3),
                        n=c(data_2021_plot2_regroup$n, 
                            data_2022A_plot2_regroup$n, 
                            data_2022B_plot2_regroup$n, 
                            data_2023_plot2_regroup$n, 
                            data_2024_plot2_regroup$n), 
                        prop=c(data_2021_plot2_regroup$prop, 
                               data_2022A_plot2_regroup$prop, 
                               data_2022B_plot2_regroup$prop, 
                               data_2023_plot2_regroup$prop, 
                               data_2024_plot2_regroup$prop), year=rep(c("2020", "2021", "2022", "2023", "2024"), each=nrow(data_2021_plot2_regroup)))
...
geom_bar(position = "dodge",stat="identity")+
  ...
  #geom_signif(annotations ="p=0.536", y_position = 0.73  ,xmin=1, xmax=5, size=1, vjust=-0.5, textsize=3.5, color="black")+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())+
  theme(legend.position = "none")
...
######## 2021 vs 2024
#res <- prop.test(x = c(data_2021_plot2_regroup%>% filter(Q3=="classical") %>% select(n) %>% pull, data_2024_plot2_regroup%>% filter(Q3=="classical") %>% select(n) %>% pull), n = c(nrow(data_2021), nrow(data_2024))) # use two sample proportion test 
#res$p.value


variable="classical"
combine_data_2=combine_data %>% filter(Q3==variable) %>% mutate(total_n=c(sum(data_2021_plot2$n), sum(data_2022A_plot2$n), sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
...
```{r, echo=F, message=F, warning=F}
colnames(data_2024)[9]="Q4"
data_2024$Q4=tolower(data_2024$Q4) # unify the response all into lower case
data_2024_plot=data_2024 %>% dplyr::count(Q4)%>% mutate(prop=round(n/nrow(data_2024),4)) 
...
```{r, echo=F, message=F, warning=F}
Q4_all_response=unique(c(unique(data_2022A$Q4), unique(data_2022B$Q4), unique(data_2023$Q4), unique(data_2024$Q4)))
...
data_2024_plot_full_response=full_join(data_2024_plot, all_response_data) %>% select(Q4, n ,prop) %>% replace(is.na(.), 0) # replace NAs with 0

combine_data=data.frame(Q4=c(data_2022A_plot_full_response$Q4, 
                             data_2022B_plot_full_response$Q4,
                             data_2023_plot_full_response$Q4, 
                             data_2024_plot_full_response$Q4),
                        n=c(data_2022A_plot_full_response$n, 
                            data_2022B_plot_full_response$n, 
                            data_2023_plot_full_response$n, 
                            data_2024_plot_full_response$n), 
                        prop=c( data_2022A_plot_full_response$prop, 
                                data_2022B_plot_full_response$prop, 
                                data_2023_plot_full_response$prop, 
                                data_2024_plot_full_response$prop), year=rep(c( "2021", "2022", "2023", "2024"), each=length(Q4_all_response)) )
...
ggplot(combine_data %>% filter(Q4=="live demo") %>% add_row(Q4="live demo", n=31, prop=0.3039, year="2020"), aes(x=year, y=prop, fill=year))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("%")+
   ylim(c(0,1))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("live demo")+
   geom_text(aes(label=round(prop,4)*100), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
  #geom_signif(annotations ="p=0.371", y_position = 0.72  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=3.5, color="black")+ # textsize is for text over the bar; size is for width of lines 
  # geom_signif(annotations ="p=0.232", y_position = 0.79  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=3.5, color="black")+
...
######## 2022A vs 2024
#res <- prop.test(x = c(data_2022A_plot%>% filter(Q4=="live demo") %>% select(n) %>% pull, data_2024_plot%>% filter(Q4=="live demo") %>% select(n) %>% pull), n = c(nrow(data_2022A), nrow(data_2024))) # use two sample proportion test 
#res$p.value


variable="live demo"
combine_data_2=combine_data %>% filter(Q4==variable) %>% mutate(total_n=c(sum(data_2022A_plot2$n), sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))%>%add_row(Q4="live demo", n=31, prop=0.3039, year="2020", total_n=(22+31+2+47))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
...
### combine most favorite choice across years 

```{r, echo=F, message=F, warning=F}
combine_data=data.frame(year=c("2020", "2021", "2022", "2023", "2024"), choice=c("video demo", "live demo", "live demo", "live demo", "power points"), prop=c(0.4608, 0.6355, 0.5660, 0.5426, 0.3131))
ggplot(combine_data, aes(x=year, y=prop, fill=choice))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("%")+
   ylim(c(0,1))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("Most favorite choice across years")+
   geom_text(aes(label=round(prop,4)*100), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
...
data_2022B_plot=data_2022B %>% dplyr::count(Q5)%>% mutate(prop=round(n/nrow(data_2022B),4)) %>% drop_na()
...
* due to missing values, Res_1+Res_2 is not equal to 100%. 
...
data_2023_plot=data_2023 %>% dplyr::count(Q5)%>% mutate(prop=round(n/nrow(data_2023),4)) %>% drop_na() 
...
```{r, echo=F, message=F, warning=F}
colnames(data_2024)[10]="Q5"
data_2024$Q5=tolower(data_2024$Q5) # unify the response all into lower case
data_2024_plot=data_2024 %>% dplyr::count(Q5)%>% mutate(prop=round(n/nrow(data_2024),4)) 

data_2024_plot=data_2024_plot%>% mutate(Response=paste("Res", seq(1:nrow(data_2024_plot)), sep="_")) %>% drop_na()
...
```{r, echo=F, message=F, warning=F}
Q5_all_response=unique(c(unique(data_2022B$Q5), unique(data_2023$Q5), unique(data_2024$Q5)))
...
#%>% replace(is.na(.), 0) # replace NAs with 0
data_2024_plot_full_response=full_join(data_2024_plot, all_response_data) %>% select(Q5, n ,prop) 
#%>% replace(is.na(.), 0) # replace NAs with 0

combine_data=data.frame(Q5=c(data_2022B_plot_full_response$Q5,
                             data_2023_plot_full_response$Q5, 
                             data_2024_plot_full_response$Q5),
                        n=c(data_2022B_plot_full_response$n, 
                            data_2023_plot_full_response$n, 
                            data_2024_plot_full_response$n), 
                        prop=c( data_2022B_plot_full_response$prop, 
                                data_2023_plot_full_response$prop, 
                                data_2024_plot_full_response$prop), year=rep(c( "2022", "2023", "2024"), each=length(Q5_all_response)) ) %>% drop_na()
...
######## 2022B vs 2024
#res <- prop.test(x = c(data_2022B_plot%>% filter(Q5=="demo of the procedure step-wise") %>% select(n) %>% pull, data_2024_plot%>% filter(Q5=="demo of the procedure step-wise") %>% select(n) %>% pull), n = c(nrow(data_2022B), nrow(data_2024))) # use two sample proportion test 
#res$p.value

variable="demo of the procedure step-wise"
combine_data_2=combine_data %>% filter(Q5==variable) %>% mutate(total_n=c(sum(data_2022B_plot2$n), sum(data_2023_plot2$n), sum(data_2024_plot2$n)))
pvalue=numeric(); k=0
year1=c(); year2=c()
for (i in 1:(nrow(combine_data_2)-1))
  for (j in (i+1):nrow(combine_data_2))
...
```{r, echo=F, message=F, warning=F}
grades=read_excel("C:\\Shengtong\\Research\\AllCollaboration\\2023\\202307\\Mohamed\\grades all years_20240429.xlsx")
```
...
```{r, echo=F, message=F, warning=F}
num_row=110
live_demo=data.frame(year2020=as.numeric(grades[3:num_row,1]%>%pull()), year2021=as.numeric(grades[3:num_row,6]%>%pull()), year2022=as.numeric(grades[3:num_row,11]%>%pull()), year2023=as.numeric(grades[3:num_row,16]%>%pull()), year2024=as.numeric(grades[3:num_row,21]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(live_demo)-1))
 for (j in (i+1):ncol(live_demo))
 {
   k=k+1
   sample1=live_demo[,i]; time1[k]=colnames(live_demo)[i]
   sample2=live_demo[,j]; time2[k]=colnames(live_demo)[j]
   t_test=t.test(sample1, sample2)
   pvalue[k]=t_test$p.value
 }
data.frame(year=paste(time1, time2, sep="_vs_"), pvalue=round(adjust_pvalue(pvalue),4))%>%
datatable(extensions = 'Buttons',
          caption = "others", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
```{r, echo=F, message=F, warning=F}
num_row=110
live_demo=data.frame(year2020=as.numeric(grades[3:num_row,2]%>%pull()), year2021=as.numeric(grades[3:num_row,7]%>%pull()), year2022=as.numeric(grades[3:num_row,12]%>%pull()), year2023=as.numeric(grades[3:num_row,17]%>%pull()), year2024=as.numeric(grades[3:num_row,22]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(live_demo)-1))
 for (j in (i+1):ncol(live_demo))
...
```{r, echo=F, message=F, warning=F}
num_row=110
live_demo=data.frame(year2020=as.numeric(grades[3:num_row,3]%>%pull()), year2021=as.numeric(grades[3:num_row,8]%>%pull()), year2022=as.numeric(grades[3:num_row,13]%>%pull()), year2023=as.numeric(grades[3:num_row,18]%>%pull()), year2024=as.numeric(grades[3:num_row,23]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(live_demo)-1))
 for (j in (i+1):ncol(live_demo))
...
```{r, echo=F, message=F, warning=F}
num_row=110
live_demo=data.frame(year2020=as.numeric(grades[3:num_row,4]%>%pull()), year2021=as.numeric(grades[3:num_row,9]%>%pull()), year2022=as.numeric(grades[3:num_row,14]%>%pull()), year2023=as.numeric(grades[3:num_row,19]%>%pull()), year2024=as.numeric(grades[3:num_row,24]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(live_demo)-1))
 for (j in (i+1):ncol(live_demo))
...
```{r, echo=F, message=F, warning=F}
num_row=110
live_demo=data.frame(year2020=as.numeric(grades[3:num_row,5]%>%pull()), year2021=as.numeric(grades[3:num_row,10]%>%pull()), year2022=as.numeric(grades[3:num_row,15]%>%pull()), year2023=as.numeric(grades[3:num_row,20]%>%pull()), year2024=as.numeric(grades[3:num_row,25]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(live_demo)-1))
 for (j in (i+1):ncol(live_demo))
...
```{r, echo=F, message=F, warning=F}
num_row=110
year=data.frame(other=as.numeric(grades[3:num_row,1]%>%pull()), word=as.numeric(grades[3:num_row,2]%>%pull()), power_point=as.numeric(grades[3:num_row,3]%>%pull()), video_demo=as.numeric(grades[3:num_row,4]%>%pull()), live_demo=as.numeric(grades[3:num_row,5]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(year)-1))
 for (j in (i+1):ncol(year))
 {
   k=k+1
   sample1=year[,i]; time1[k]=colnames(year)[i]
   sample2=year[,j]; time2[k]=colnames(year)[j]
   t_test=t.test(sample1, sample2)
   pvalue[k]=t_test$p.value
 }
data.frame(year=paste(time1, time2, sep="_vs_"), pvalue=round(adjust_pvalue(pvalue),4))%>%
...
```{r, echo=F, message=F, warning=F}
num_row=110
year=data.frame(other=as.numeric(grades[3:num_row,6]%>%pull()), word=as.numeric(grades[3:num_row,7]%>%pull()), power_point=as.numeric(grades[3:num_row,8]%>%pull()), video_demo=as.numeric(grades[3:num_row,9]%>%pull()), live_demo=as.numeric(grades[3:num_row,10]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(year)-1))
 for (j in (i+1):ncol(year))
...
```{r, echo=F, message=F, warning=F}
num_row=110
year=data.frame(other=as.numeric(grades[3:num_row,11]%>%pull()), word=as.numeric(grades[3:num_row,12]%>%pull()), power_point=as.numeric(grades[3:num_row,13]%>%pull()), video_demo=as.numeric(grades[3:num_row,14]%>%pull()), live_demo=as.numeric(grades[3:num_row,15]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(year)-1))
 for (j in (i+1):ncol(year))
...
```{r, echo=F, message=F, warning=F}
num_row=110
year=data.frame(other=as.numeric(grades[3:num_row,16]%>%pull()), word=as.numeric(grades[3:num_row,17]%>%pull()), power_point=as.numeric(grades[3:num_row,18]%>%pull()), video_demo=as.numeric(grades[3:num_row,19]%>%pull()), live_demo=as.numeric(grades[3:num_row,20]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(year)-1))
 for (j in (i+1):ncol(year))
...
```{r, echo=F, message=F, warning=F}
num_row=110
year=data.frame(other=as.numeric(grades[3:num_row,21]%>%pull()), word=as.numeric(grades[3:num_row,22]%>%pull()), power_point=as.numeric(grades[3:num_row,23]%>%pull()), video_demo=as.numeric(grades[3:num_row,24]%>%pull()), live_demo=as.numeric(grades[3:num_row,25]%>%pull()))
pvalue=numeric(); time1=c(); time2=c()
k=0
for (i in 1:(ncol(year)-1))
 for (j in (i+1):ncol(year))
...
Statistical software R version 4.3.2 was used for all analysis. Two sample proportion test by R function-prop.test was used to test the proportion difference between two groups. Statistical significance was determined when p value is less than 0.05.   
