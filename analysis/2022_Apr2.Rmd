...
y=numeric(); col_index=c(2,5,11,20); ii=0 # for each subject, extract measurements at different time points/occasions 
...
y=numeric(); col_index=c(3,6,12,21); ii=0 # for each subject, extract measurements at different time points/occasions 
for (i in 1:nrow(Research_Measurements))
 for (j in 1:length(col_index))
 {
   ii=ii+1
...
y=numeric(); col_index=c(4,7,13,22); ii=0 # for each subject, extract measurements at different time points/occasions 
for (i in 1:nrow(Research_Measurements))
 for (j in 1:length(col_index))
 {
   ii=ii+1
