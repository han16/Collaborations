...
data.frame(variables=c("OCP_saline_vs_NaoCI", paste("OCP", brands, sep="_")), pearson_cor=round(pearson_cor,4), pearson_cor_pvalue=pvalue_adjust(pearson_cor_pvalue), spearman_cor=round(spearman_cor,4), spearman_cor_pvalue=pvalue_adjust(spearman_cor_pvalue))%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data.frame(variables=c("Icorr_saline_vs_NaoCI", paste("Icorr", brands, sep="_")), pearson_cor=round(pearson_cor,4), pearson_cor_pvalue=pvalue_adjust(pearson_cor_pvalue), spearman_cor=round(spearman_cor,4), spearman_cor_pvalue=pvalue_adjust(spearman_cor_pvalue))%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
