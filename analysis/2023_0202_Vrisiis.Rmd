...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="Width_diff_3mm", main="", col=c(2,4))
...
ggplot(sub_data_mean, aes(x=time, y=Buccal_3mm_mean, fill=methods)) + 
  ...
  geom_errorbar(aes(ymin=Buccal_3mm_mean-Buccal_3mm_sd, ymax=Buccal_3mm_mean+Buccal_3mm_sd), width=.2,
                 position=position_dodge(.9))+
  geom_text(aes(label=round(Buccal_3mm_mean,2)), position=position_dodge(width=0.8), vjust=-0.5, color="red")+  # add numbers over bars; vjust: adjust the vertical position of numbers 
  #ylim(c(0,19))+
  geom_signif(annotations ="p=0.424", y_position = 2  ,xmin=0.7, xmax=1.2, size=1, vjust=-0.5, textsize=3)+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p=0.353", y_position = 2  ,xmin=1.7, xmax=2.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.274", y_position = 2  ,xmin=2.7, xmax=3.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.331", y_position = 2  ,xmin=3.7, xmax=4.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.589", y_position = 2.3  ,xmin=4.7, xmax=5.3, size=1, vjust=-0.5, textsize=3.0, color="black")
...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="Buccal_3mm", main="", col=c(2,4))
...
ggplot(sub_data_mean, aes(x=time, y=Lingual_3mm_mean, fill=methods)) + 
  ...
  geom_errorbar(aes(ymin=Lingual_3mm_mean-Lingual_3mm_sd, ymax=Lingual_3mm_mean+Lingual_3mm_sd), width=.2,
                 position=position_dodge(.9))+
  geom_text(aes(label=round(Lingual_3mm_mean,2)), position=position_dodge(width=0.8), vjust=-0.5, color="red")+  # add numbers over bars; vjust: adjust the vertical position of numbers 
  #ylim(c(0,19))+
  geom_signif(annotations ="p=0.071", y_position = 3  ,xmin=0.7, xmax=1.2, size=1, vjust=-0.5, textsize=3)+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p=0.073", y_position = 3  ,xmin=1.7, xmax=2.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.077", y_position = 3  ,xmin=2.7, xmax=3.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.069", y_position = 3  ,xmin=3.7, xmax=4.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.079", y_position = 3  ,xmin=4.7, xmax=5.3, size=1, vjust=-0.5, textsize=3.0, color="black")
...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="Lingual_3mm", main="", col=c(2,4))
...
ggplot(sub_data_mean, aes(x=time, y=Vertical_mid_mean, fill=methods)) + 
  ...
  geom_errorbar(aes(ymin=Vertical_mid_mean-Vertical_mid_sd, ymax=Vertical_mid_mean+Vertical_mid_sd), width=.2,
                 position=position_dodge(.9))+
  geom_text(aes(label=round(Vertical_mid_mean,2)), position=position_dodge(width=0.8), vjust=-0.5, color="red")+  # add numbers over bars; vjust: adjust the vertical position of numbers 
  #ylim(c(0,19))+
...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="Vertical_mid", main="", col=c(2,4))
...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="Vertical_max", main="", col=c(2,4))
...
######### plot mean curve 
interaction.plot(time, treatment, y, type="b", pch=c(19,21), xlab="Time", ylab="%vol", main="", col=c(2,4))
