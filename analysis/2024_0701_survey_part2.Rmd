...
load(file.path(root, "..\\2024\\202407\\Dental_Hygienist_WI.RData"))
...
fig=side_by_side_barplot(gender_zones_data, angle=0, num_size = 3, x_text_size=12, legend_text_size=12, title="Hygienist", custom_colors= c("Woman" = "red", "Man" = "green"))
fig


fig=side_by_side_barplot3(gender_zones_data, angle=0, num_size = 3, x_text_size=12, legend_text_size=12, title="Hygienist", custom_colors= c("Woman" = "red", "Man" = "green"), x_var="geo", fill_var = "gender")
fig
