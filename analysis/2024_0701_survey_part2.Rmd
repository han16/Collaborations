...
cat("average age (in years) is:", round(mean(ages),1), "\n")
...
cat("people not mapped to geo ragion by zip code:", nrow(Dental_Hygienist_WI %>% filter(!`5-digit Zip code` %in% unlist(region_code_zip))), "\n")
