...
data.frame(sheet=names(data), kendall_value=round(kendall_value,4), kendall_pvalue=pvalue_adjust(kendall_pvalue)) %>%
datatable(extensions = 'Buttons',
...
data.frame(sheet=names(data), icc_value=round(icc_value,4), icc_pvalue=pvalue_adjust(icc_pvalue)) %>%
datatable(extensions = 'Buttons',
          caption = "CVMS IH vs CVMS 2H", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
data.frame(sheet=names(data), ccc_value=round(unlist(ccc_value),4)) %>%
datatable(extensions = 'Buttons',
          caption = "CVMS IH vs CVMS 2H", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
