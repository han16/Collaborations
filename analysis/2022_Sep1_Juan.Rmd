...
for (i in 1:ncol(sub_data))
{
  ...
  median[i]=summary(sub_data[,i])[3]
  Q1[i]=summary(sub_data[,i])[2]
  Q3[i]=summary(sub_data[,i])[5]
  
}

data.frame(Time=c("Age", "Time_bone_graft", "Ging_thick", "Muc_thick", "Duration(min)", "Suture_removal", "Ging_width_T1", "Ging_width_T6"), Mean=Mean, Median=median, Q1=Q1, Q3=Q3, SD=SD, SE=SE, Range_low=range_min, Range_upper=range_max)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data.frame(Time=c("T1", "T2", "T3", "T4", "T5", "T6"), Mean=Mean, Median=Median, Q1=Q1, Q3=Q3, SD=SD, SE=SE, Range_low=Range_low, Range_upper=Range_upper, normality_pvalue= normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[12:16], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
{
sub_data=data.frame(swelling=data %>% select(variables[i]) %>% pull, cova=data%>% select(Type_bone_graft) %>% pull)
lm_reg=lm(swelling~as.character(cova), data=sub_data)  
pvalue[i]=lmp(lm_reg) # get regression model p value
}
data.frame(variables, anova_pvalue=pvalue_adjust(pvalue))%>%
datatable(extensions = 'Buttons',
          caption="effect of Type_bone_graft",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
```{r, echo=F, message=F, warning=F}
variables=c("Width_diff_3mm_T2.T1", "Width_diff_3mm_T3.T2", "Width_diff_3mm_T4.T2","Width_diff_3mm_T5.T2","width_diff_3mm_T6.T2")
covariate="Time_bone_graft..months."
pvalue=numeric()
for (i in 1:length(variables))
{
sub_data=data.frame(swelling=data %>% select(variables[i]) %>% pull, cova=data%>% select(covariate) %>% pull)
lm_reg=lm(swelling~cova, data=sub_data)  
pvalue[i]=lmp(lm_reg) # get regression model p value
}
data.frame(variables, anova_pvalue=pvalue_adjust(pvalue))%>%
datatable(extensions = 'Buttons',
...
variables=c("Width_diff_3mm_T2.T1", "Width_diff_3mm_T3.T2", "Width_diff_3mm_T4.T2","Width_diff_3mm_T5.T2","width_diff_3mm_T6.T2")
covariate="Site"
site_split=data$Site
site_split[data$Site<=16]="Maxilla"
site_split[data$Site>16]="mandible"
pvalue=numeric()
for (i in 1:length(variables))
{
sub_data=data.frame(swelling=data %>% select(variables[i]) %>% pull, cova=data%>% select(covariate) %>% pull)

sub_data=sub_data %>% mutate(site_split=site_split)
lm_reg=lm(swelling~site_split, data=sub_data)  
pvalue[i]=lmp(lm_reg) # get regression model p value
}
data.frame(variables, anova_pvalue=pvalue_adjust(pvalue))%>%
datatable(extensions = 'Buttons',
...
data_frame(parameter=colnames(data)[17:21], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[22:26], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[27:31], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[32:36], mean=round(estimate,2),  Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[45:49], mean=round(estimate,2),  Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[50:54], mean=round(estimate,2), Median, Q1, Q3,  CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[55:59], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[60:64], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[65:69], mean=round(estimate,2), Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
data_frame(parameter=colnames(data)[70:73], mean=round(estimate,2),  Median, Q1, Q3, CI_lower=round(CI_lower,2),  CI_upper=round(CI_upper,2), p_value=pvalue_adjust(p_value), SD=round(SD,4), SE=round(SE,4),  minimum=round(minimum,4),  maximum=round(maximum, 4), normality_pvalue=normality_pvalue)%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
* [correlation matrix and p values](https://marq-my.sharepoint.com/:x:/g/personal/shengtong_han_marquette_edu/EUHKs-fEVP5Nvq3zf7oc5ksBfpLMhRZnOExoQ5SwYrtq8g?e=WF8Vep), i.e. `correlation_pvalue`. 
