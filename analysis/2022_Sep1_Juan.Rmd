...
```{r, echo=F, message=F, warning=F}
parametric_pvalue=numeric()
non_parametric_pvalue=numeric()
for (i in 1:5)
{
  sample1=data[,(11+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[12:16], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
* parametric test is using two sample t test and non-parametric test is wilcox test 
* p value less than 5% suggests that variable is statistically significant away from 0. 
...
for (i in 1:5)
{
  sample1=data[,(16+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[17:21], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
for (i in 1:5)
{
  sample1=data[,(21+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[22:26], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
for (i in 1:5)
{
  sample1=data[,(26+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[27:31], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
for (i in 1:5)
{
  sample1=data[,(31+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[32:36], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
for (i in 1:5)
{
  sample1=data[,(44+i)] %>% pull
  sample2=rep(0, length(sample1))
  parametric_pvalue[i]=t.test(sample1, sample2)$p.value
  non_parametric_pvalue[i]=wilcox.test(sample1, sample2)$p.value
}
data.frame(variables=colnames(data)[45:49], parametric_pvalue=pvalue_adjust(parametric_pvalue), non_parametric_pvalue=pvalue_adjust(non_parametric_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
sub_data=data.frame(Ging_width_T1=data$Ging_width_T1, Ging_width_T6=data$Ging_width_T6, Ging_thick=data$Ging_thick, Muc_thick=data$Muc_thick,Wound_open_bl_T3=data$Wound_open_bl_T3, Wound_open_bl_T4=data$Wound_open_bl_T4, Wound_open_bl_T5=data$Wound_open_bl_T5, Wound_open_bl_T6=data$Wound_open_bl_T6,Width_3mm_T1=data$Width_3mm_T1
,Width_3mm_T2=data$Width_3mm_T2, Width_3mm_T3=data$width_3mm_T3, Width_3mm_T4=data$Width_3mm_T4,
Width_3mm_T5=data$Width_3mm_T5, Width_3mm_T6=data$Width_3mm_T6, Width_diff_3mm_T2_T1=data$Width_diff_3mm_T2.T1, Width_diff_3mm_T3_T2=data$Width_diff_3mm_T3.T2, Width_diff_3mm_T4_T2=data$Width_diff_3mm_T4.T2, Width_diff_3mm_T5_T2=data$Width_diff_3mm_T5.T2, Width_diff_3mm_T6_T2=data$width_diff_3mm_T6.T2, Buccal_3mm_T2_T1=data$Buccal_3mm_T2.T1, Buccal_3mm_T2_T3=data$Buccal_3mm_T2.T3, Buccal_3mm_T2_T4=data$Buccal_3mm_T2.T4, Buccal_3mm_T2_T5=data$Buccal_3mm_T2.T5, Buccal_3mm_T2_T6=data$Buccal_3mm_T2.T6, Lingual_3mm_T2_T1=data$Lingual_3mm_T2.T1, Lingual_3mm_T2_T3=data$Lingual_3mm_T2.T3, Lingual_3mm_T2_T4=data$Lingual_3mm_T2.T4, Lingual_3mm_T2_T5=data$Lingual_3mm_T2.T5, Lingual_3mm_T2_T6=data$Lingual_3mm_T2.T6, Vertical_mid_T2_T1=data$Vertical_mid_T2.T1, Vertical_mid_T2_T3=data$Vertical_mid_T2.T3, Vertical_mid_T2_T4=data$Vertical_mid_T2.T4, Vertical_mid_T2_T5=data$Vertical_mid_T2.T5, Vertical_mid_T2_T6=data$Vertical_mid_T2.T6, Vertical_max_T2_T1=data$Vertical_max_T2.T1, Vertical_max_T2_T3=data$Vertical_max_T2.T3, Vertical_max_T2_T4=data$Vertical_max_T2.T4, Vertical_max_T2_T5=data$Vertical_max_T2.T5, Vertical_max_T2_T6=data$Vertical_max_T2.T6, X.Vol_T2.T1.T1=data$X.Vol_T2.T1.T1, X.Vol_T3.T2.T2=data$X.Vol_T3.T2.T2, X.Vol_T4.T2.T2=data$X.Vol_T4.T2.T2,  X.Vol_T5.T2.T2=data$X.Vol_T5.T2.T2,  X.Vol_T6.T2.T2=data$X.Vol_T6.T2.T2, VAS_pain_T1=data$VAS_pain_T1, VAS_pain_T3=data$VAS_pain_T3, VAS_pain_T4=data$VAS_pain_T4, VAS_pain_T5=data$VAS_pain_T5, VAS_pain_T6=data$VAS_pain_T6, VAS_swell_T1=data$VAS_swell_T1,VAS_swell_T3=data$VAS_swell_T3, VAS_swell_T4=data$VAS_swell_T4, VAS_swell_T5=data$VAS_swell_T5, VAS_swell_T6=data$VAS_swell_T6, VAS_mouth_open_T1=data$VAS_mouth_open_T1, VAS_mouth_open_T3=data$VAS_mouth_open_T3, VAS_mouth_open_T4=data$VAS_mouth_open_T4, VAS_mouth_open_T5=data$VAS_mouth_open_T5, VAS_mouth_open_T6=data$VAS_mouth_open_T6, OHIP_T1=data$OHIP_T1, OHIP_T3=data$OHIP_T3, OHIP_T4=data$OHIP_T4, OHIP_T5=data$OHIP.T5, OHIP_T6=data$OHIP_T6, duration=data$Duration.min.)
################ compute p values 
...
#write.csv(correlation_pvalue, file="../../2022/202209/Juan/Juan_spearman_correlation_matrix_pvalue_2025_0213_full.csv")
#cormat2%>%
#datatable(extensions = 'Buttons',
#            options = list(dom = 'Blfrtip',
#                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
* [spearman correlation matrix and p values](https://marq-my.sharepoint.com/:x:/g/personal/shengtong_han_marquette_edu/EXom4m56R1lGvzIe1yOfCB8BrvKjP6j7OG8uh-rEW5_2hA?e=8kwDlm), i.e. `correlation_pvalue`. 
...
#write.csv(correlation_pvalue, file="../../2022/202209/Juan/Juan_spearman_correlation_matrix_pvalue_2025_0213_subset.csv")
#cormat2%>%
#datatable(extensions = 'Buttons',
#            options = list(dom = 'Blfrtip',
#                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
* [spearman correlation matrix and p values](https://marq-my.sharepoint.com/:x:/g/personal/shengtong_han_marquette_edu/ERK9cvbJox5NmJKVMvgZRbMBpAaVe-HZ7bxkHA4DZWTKXQ?e=zyzCKI), i.e. `correlation_pvalue`. 
...
Do single tooth anterior sites tend to swell more or less than posterior sites?


```{r, message=F, warning=F}
group1_esthetic_zone=c(12, 16, 25, 41, 43, 44, 49, 52, 59, 63, 64)
group2_non_esthetic_zone=c(14, 26, 28, 32, 36, 50, 51, 53, 54, 58, 61, 65, 66, 67, 68)
pvalue=numeric()
variables_index=c(6:36, 45:49)
for (i in 1:length(variables_index))
{
  sample1=data %>% filter(Subject %in% group1_esthetic_zone) %>% select(all_of(colnames(data))[variables_index[i]]) %>% pull()
  sample2=data %>% filter(Subject %in% group2_non_esthetic_zone) %>% select(all_of(colnames(data))[variables_index[i]]) %>% pull()
  pvalue[i]=t.test(sample1, sample2)$p.value
  
}

data.frame(variables=colnames(data)[variables_index], pvalue=pvalue_adjust(pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
