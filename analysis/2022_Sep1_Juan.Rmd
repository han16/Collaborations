...
* p value of 0.7824 by two sample t test suggests no difference between `Ging_width_T1` and `Ging_width_T6`
* IQR is Q3-Q1. 
...
data.frame(variables, Type_bone_graft_pvalue=pvalue_adjust(Type_bone_graft_pvalue), Time_bone_graft_month_pvalue=pvalue_adjust(Time_bone_graft_month_pvalue), site_split1_pvalue=pvalue_adjust(site_split1_pvalue), site_split1_kruskal_pvalue=pvalue_adjust(site_split1_kruskal_pvalue), site_split2_pvalue=pvalue_adjust(site_split2_pvalue), 
...
data.frame(variables, Type_bone_graft_pvalue=pvalue_adjust(Type_bone_graft_pvalue), Time_bone_graft_month_pvalue=pvalue_adjust(Time_bone_graft_month_pvalue), 
