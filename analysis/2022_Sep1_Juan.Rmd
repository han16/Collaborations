...
data.frame(variables, Type_bone_graft_pvalue=pvalue_adjust(Type_bone_graft_pvalue), Time_bone_graft_month_pvalue=pvalue_adjust(Time_bone_graft_month_pvalue), site_split1_pvalue=pvalue_adjust(site_split1_pvalue), site_split2_pvalue=pvalue_adjust(site_split2_pvalue), site_split3_pvalue=pvalue_adjust(site_split3_pvalue))%>%
datatable(extensions = 'Buttons',
          caption="",
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
* anova test was used for categorical variables and linear regression for continuous variabels 
