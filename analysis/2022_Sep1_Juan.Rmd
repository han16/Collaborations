...
{
sub_data=data.frame(swelling=data %>% select(variables[i]) %>% pull, Type_bone_graft=data%>% select(Type_bone_graft) %>% pull)
lm_reg=lm(swelling~as.character(Type_bone_graft), data=sub_data)  
