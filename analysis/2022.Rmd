...
project_progress=data.frame(project=seq(1,18), progress=c(100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,100,100,100, 100,90, 0))
...
coord_flip()+ 
 theme_gray() +
  ...
  ggtitle("as of 10/17/2022")+  # add title information 
