...
### split 2 other into 1 in resore and 1 in cORR, requested by Vrisiis  
data_subset1[5,2]=1; 
data_subset2=rbind(data_subset2, c(6,1))
data_subset2=data_subset2[order(data_subset2$Pre_implant_Procedure),]


data_subset=data_frame(Pre_implant_Procedure=data_subset1$Pre_implant_Procedure, n=data_subset1$n+data_subset2$n) %>% mutate(prop=round(n/(num_indi1+num_indi2),4))
...
* 2 other was split into 1 in each sample. 
