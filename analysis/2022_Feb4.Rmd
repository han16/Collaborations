...
glm_fit=glm(as.factor(med_history_arthritis)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial")
...
glm_fit=glm(as.factor(Bulimia_acid_reflux_sleep_apnea)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial")
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
...
```{r, echo=F, message=F, warning=F}
sub_data=data%>%filter(med_history_depression!=2)
glm_fit=glm(as.factor(med_history_arthritis)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial")
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
...
glm_fit=glm(as.factor(diabetes)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial") # response variable need to be factor 
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
...
glm_fit=glm(as.factor(thyroid_diseases)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial") # response variable need to be factor 
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
```
...
glm_fit=glm(as.factor(cancer_treatment)~Age_at_exam  + Sex + county, data = sub_data, family = "binomial") # response variable need to be factor 
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
```
