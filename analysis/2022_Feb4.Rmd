...
* for continuous predictor, expected log count increase by  $\widehat{\beta}$ and for categorical predictors, it is the expected log count between different groups.  
