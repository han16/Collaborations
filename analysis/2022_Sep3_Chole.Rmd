...
annotate_figure(figure,
                top = text_grob(questions[1], color = "red", face = "bold", size = 14),
...
#g1
  ...
  figure=ggarrange(g1, g2, common.legend = TRUE, legend="right") 
annotate_figure(figure,
                top = text_grob(questions[2], color = "red", face = "bold", size = 14),
#                bottom = text_grob("Data source: \n ToothGrowth data set", color = "blue",
#                                   hjust = 1, x = 1, face = "italic", size = 10),
#                left = text_grob("Tooth length", color = "green", rot = 90),
#                right = "I'm done, thanks :-)!",
...
#g1
  ...
  figure=ggarrange(g1, g2, common.legend = TRUE, legend="right") 
annotate_figure(figure,
                top = text_grob(questions[3], color = "red", face = "bold", size = 14),
#                bottom = text_grob("Data source: \n ToothGrowth data set", color = "blue",
#                                   hjust = 1, x = 1, face = "italic", size = 10),
#                left = text_grob("Tooth length", color = "green", rot = 90),
#                right = "I'm done, thanks :-)!",
...
```{r, echo=F, message=F, warning=F}
classical_music=as_tibble(read.csv("C:\\Shengtong\\Research\\AllCollaboration\\2022\\202209\\Chloe\\Variable 1 - Classical Music.csv", header=T))
questions=colnames(classical_music)[6:9]

################### question 1
classical_music_plot1=classical_music %>% count(by=How.did.the.music.impact.your.energy.level.during.class.)%>% mutate(prop=n/nrow(classical_music))
################### question 2
classical_music_plot2=classical_music %>% count(by=How.easy.was.it.to.focus.during.this.class.period.)%>% mutate(prop=n/nrow(classical_music))
################### question 3
classical_music_plot3=classical_music %>% count(by=How.did.the.music.played.during.today.s.session.impact.your.concentration.when.performing.root.canal.treatments.of..9.and.or..4.)%>% mutate(prop=n/nrow(classical_music))

################### question 4
classical_music_plot4=classical_music %>% count(by=Did.the.music.selection.today.interfere.with.your.ability.to.complete.the.root.canal.treatment.on..9.and.or..4.)%>% mutate(prop=n/nrow(classical_music))
...
################### question 1
hip_hop_music_plot1=hip_hop_music %>% count(by=How.did.the.music.impact.your.energy.level.during.class.)%>% mutate(prop=n/nrow(no_music))
################### question 2
hip_hop_music_plot2=hip_hop_music %>% count(by=How.easy.was.it.to.focus.during.this.class.period.)%>% mutate(prop=n/nrow(hip_hop_music))  # should add one row 
hip_hop_music_plot2=hip_hop_music_plot2 %>%add_row(by= 4, n= 0, prop=0)
################### question 3
hip_hop_music_plot3=hip_hop_music %>% count(by=How.did.the.music.played.during.today.s.session.impact.your.concentration.when.performing.root.canal.treatments.of..9.and.or..4.)%>% mutate(prop=n/nrow(hip_hop_music))

################### question 4
hip_hop_music_plot4=hip_hop_music %>% count(by=Did.the.music.selection.today.interfere.with.your.ability.to.complete.the.root.canal.treatment.on..9.and.or..4.)%>% mutate(prop=n/nrow(hip_hop_music))
...
################### question 1
student_playlist_music_plot1=hip_hop_music %>% count(by=How.did.the.music.impact.your.energy.level.during.class.)%>% mutate(prop=n/nrow(no_music))
################### question 2
student_playlist_music_plot2=student_playlist_music %>% count(by=How.easy.was.it.to.focus.during.this.class.period.)%>% mutate(prop=n/nrow(hip_hop_music))  # should add one row 
student_playlist_music_plot2=student_playlist_music_plot2 %>%add_row(by= 4, n= 0, prop=0)
################### question 3
student_playlist_music_plot3=student_playlist_music %>% count(by=How.did.the.music.played.during.today.s.session.impact.your.concentration.when.performing.root.canal.treatments.of..9.and.or..4.)%>% mutate(prop=n/nrow(hip_hop_music))

################### question 4
student_playlist_music_plot4=student_playlist_music %>% count(by=Did.the.music.selection.today.interfere.with.your.ability.to.complete.the.root.canal.treatment.on..9.and.or..4.)%>% mutate(prop=n/nrow(hip_hop_music))
