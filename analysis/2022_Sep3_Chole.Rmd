...
```{r, echo=F, message=F, warning=F}
data_for_plot=data.frame(music=c("Yes", "Yes", "Yes", "No", "No", "No"), music_type=c("classical", "hip hop", "student playlist", "classical", "hip hop", "student playlist"), mean=c(mean(classical), mean(hip_hop), mean(student_playlist), mean(control), mean(control), mean(control)), sd=c(sd(classical), sd(hip_hop), sd(student_playlist), sd(control), sd(control), sd(control)))

ggplot(data_for_plot, aes(x=music_type, y=mean, fill=music)) + 
  geom_bar(stat="identity", color="black", 
           position=position_dodge()) +
  ylim(c(0,120))+
  ylab("Average grades")+xlab("")+
  geom_errorbar(aes(ymin=mean-sd, ymax=mean+sd), width=.2,
                 position=position_dodge(.9))+
  geom_text(aes(label=round(mean,2)), position=position_dodge(width=0.8), vjust=3.5)+  # add numbers over bars; vjust: adjust the vertical position of numbers 
geom_signif(annotations ="p<0.0001", y_position = 104  ,xmin=0.7, xmax=1.2, size=1, vjust=-0.5, textsize=3)+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p<0.0001", y_position = 102  ,xmin=1.7, xmax=2.3, size=1, vjust=-0.5, textsize=3.0)+
geom_signif(annotations ="p<0.0001", y_position = 103  ,xmin=2.7, xmax=3.3, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.003", y_position = 110  ,xmin=2.35, xmax=3.3, size=1, vjust=-0.5, textsize=3.0)+
   geom_signif(annotations ="p=0.127", y_position = 110  ,xmin=1.2, xmax=2.25, size=1, vjust=-0.5, textsize=3.0)+
  geom_signif(annotations ="p=0.164", y_position = 117  ,xmin=1.2, xmax=3.3, size=1, vjust=-0.5, textsize=3.0)
```
...
g1=ggplot(no_music_plot1, aes(x=by, y=prop, fill=as.character(by))) +geom_bar(stat="identity")+
...
#g1
  g2=ggplot(no_music_plot1, aes(x=by, y=n, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("count")+
    xlab("")+
...
################
p_value=numeric()
count=no_music_plot1$n
p_value[1]=pvalue_adjust(binom.test(c(count[1],count[2]))$p.value)
p_value[2]=pvalue_adjust(binom.test(c(count[1],count[3]))$p.value)
p_value[3]=pvalue_adjust(binom.test(c(count[2],count[3]))$p.value)
data.frame(variables=c("1 vs 2", "1 vs 3", "2 vs 3"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison between responses", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
################### question 2
no_music_plot2=no_music %>% count(by=How.easy.was.it.to.focus.during.class.periods.without.music.)%>% mutate(prop=n/nrow(no_music))
g1=ggplot(no_music_plot2, aes(x=by, y=prop, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("%")+ylim(c(0,1))+
    xlab("")+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(no_music_plot2, aes(x=by, y=n, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("count")+
    xlab("")+
...
################### question 3
no_music_plot3=no_music %>% count(by=How.did.2t.having.music.played.during.previous.sessions.impact.your.concentration.when.performing.root.canal.treatments.of..9.and.or..4.)%>% mutate(prop=n/nrow(no_music))
g1=ggplot(no_music_plot3, aes(x=by, y=prop, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("%")+ylim(c(0,1))+
    xlab("")+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(no_music_plot3, aes(x=by, y=n, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("count")+
    xlab("")+
...
################### question 4
no_music_plot4=no_music %>% count(by=Did.2t.having.music.played.interfere.with.your.ability.to.complete.the.root.canal.treatment.on..9.and.or..4.)%>% mutate(prop=n/nrow(no_music))
g1=ggplot(no_music_plot4, aes(x=by, y=prop, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("%")+ylim(c(0,1))+
    xlab("")+
  ...
  #theme(plot.title = element_text(hjust = 0.5, size=10))  #center the title 
#g1
  g2=ggplot(no_music_plot4, aes(x=by, y=n, fill=as.character(by))) +geom_bar(stat="identity")+
  theme(legend.position="none")+
  theme(axis.text.x = element_text(angle = 0, vjust = 0.5, size=12))+
  ylab("count")+
    xlab("")+
...
################
p_value=numeric()
count=no_music_plot4$n
p_value[1]=pvalue_adjust(binom.test(c(count[1],count[2]))$p.value)
data.frame(variables=c("1 vs 2"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison between responses", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
...
data.frame(variables=c("1 vs 2", "1 vs 3", "2 vs 3"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison for classical music in Q1", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
data.frame(variables=c("1 vs 2", "1 vs 3", "2 vs 3"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison for hip hop in Q1", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
data.frame(variables=c("1 vs 2", "1 vs 3", "2 vs 3"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison for no music in Q1", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
data.frame(variables=c("1 vs 2", "1 vs 3", "2 vs 3"), pvalue=p_value)%>%
datatable(extensions = 'Buttons',
          caption=" comparison for student playlist in Q1", 
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
                                             c(10,25,50,"All"))))
...
```{r, echo=F, message=F, warning=F}
###############
g1=ggplot(combine %>% filter(question=="Q1" & music_type=="classical music"), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,90))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("classical music in Q1")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
  geom_signif(annotations ="p=0.033", y_position = 64  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p<0.0001", y_position = 42  ,xmin=2, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="red")+
  geom_signif(annotations ="p<0.0001", y_position = 75  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="red")+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())


###############
g2=ggplot(combine %>% filter(question=="Q1" & music_type=="hip hop"), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,135))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("hip hop in Q1")+
    geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=0.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 110  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p=0.178", y_position = 25  ,xmin=2, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="black")+
  geom_signif(annotations ="p<0.0001", y_position = 125  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="red")+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())

#################
g3=ggplot(combine %>% filter(question=="Q1" & music_type=="no_music"), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,100))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("no music in Q1")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=0.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 70  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p=0.098", y_position = 75  ,xmin=2, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="black")+
  geom_signif(annotations ="p<0.0001", y_position = 85  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="red")+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())
 
#################
g4=ggplot(combine %>% filter(question=="Q1" & music_type=="student playlist"), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,135))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("student playlist in Q1")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=0.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 110  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   geom_signif(annotations ="p=0.178", y_position = 25  ,xmin=2, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="black")+
  geom_signif(annotations ="p<0.0001", y_position = 125  ,xmin=1, xmax=3, size=1, vjust=-0.5, textsize=2.5, color="red")+
...
figure=ggarrange(g1, g2, g3, g4, common.legend = TRUE, legend="right") 
annotate_figure(figure,
...
geom_bar(position = "dodge",stat="identity")+
  ...
  # ggtitle("Response of Q1")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=-0.25)+  # add numbers over bars 
#  geom_signif(annotations ="p=0.033", y_position = 64  ,xmin=0.7, xmax=1.2, size=1, vjust=-0.5, textsize=3)+ # textsize is for text over the bar; size is for width of lines 
#   geom_signif(annotations ="p<0.0001", y_position = 42  ,xmin=1.7, xmax=2.3, size=1, vjust=-0.5, textsize=3.0)+
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())+
...
```{r, echo=F, message=F, warning=F}
g1=ggplot(data.frame(response=c(1,2),count=c(90,17)), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,110))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("classical music in Q2")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 95  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())
#g1

g2=ggplot(data.frame(response=c(1,2),count=c(102,5)), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,130))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("hip hop in Q2")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=-0.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 120  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())
#g2

g3=ggplot(data.frame(response=c(1,2),count=c(83,26)), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,110))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("no music in Q2")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=1.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 85  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())
#g3

g4=ggplot(data.frame(response=c(1,2),count=c(103,4)), aes(x=as.character(response), y=count, fill=as.character(response)))+ 
geom_bar(position = "dodge",stat="identity")+
   xlab("")+ylab("count")+
   ylim(c(0,130))+
   theme(axis.text.x = element_text(angle =0, vjust = 0.5, size=8))+
   ggtitle("student playlist in Q2")+
   geom_text(aes(label=count), position=position_dodge(width=0.9), vjust=-0.25)+  # add numbers over bars 
  geom_signif(annotations ="p<0.0001", y_position = 120  ,xmin=1, xmax=2, size=1, vjust=-0.5, textsize=2.5, color="red")+ # textsize is for text over the bar; size is for width of lines 
   theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title
  theme(legend.title=element_blank())
...
```{r, echo=F, message=F, warning=F}
#Q1$n 
popularity=c(0, 44, 7,52)
# Q2$n
concentration=c(2,34,22,45)
#cor(popularity,concentration)
#cor.test(popularity,concentration)
```

* correlation between popularity and concentration is 0.92 with p value of 0.07. 

### grades vs Q2 

```{r, echo=F, message=F, warning=F}
#Q1$n 
grades=c(mean(control), mean(hip_hop), mean(classical),mean(student_playlist))
# Q2$n
concentration=c(2,34,22,45)
#cor(grades,concentration)
#cor.test(grades,concentration)
###########
#regress_data=data.frame(grades=grades, concentration=concentration)
#summary(lm(concentration~grades, data=regress_data))
```

* correlation between grades average and concentration is 0.89 with p value of 0.11. 
