...
data_conti$Height_coronal_CBCT1 <- ifelse(
  replace_na(data_conti$ANPNS_Crest_Coronal_CBCT1, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_CBCT1, 0) == 0,
  NA,
  replace_na(data_conti$ANPNS_Crest_Coronal_CBCT1, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_CBCT1, 0)
)
data_conti$ANPNS_Crest_Coronal_CBCT1[data_conti$ANPNS_Crest_Coronal_CBCT1 == 0] <- NA
data_conti$MENTAL_Crest_Coronal_CBCT1[data_conti$MENTAL_Crest_Coronal_CBCT1 == 0] <- NA

##############

data_conti$Height_coronal_CBCT2 <- ifelse(
  replace_na(data_conti$ANSPNS_Crest_Coronal_CBCT2, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_CBCT2, 0) == 0,
  NA,
  replace_na(data_conti$ANSPNS_Crest_Coronal_CBCT2, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_CBCT2, 0)
)
data_conti$ANSPNS_Crest_Coronal_CBCT2[data_conti$ANSPNS_Crest_Coronal_CBCT2 == 0] <- NA
data_conti$MENTAL_Crest_Coronal_CBCT2[data_conti$MENTAL_Crest_Coronal_CBCT2 == 0] <- NA

##############

data_conti$Height_sagittal_CBCT1 <- ifelse(
  replace_na(data_conti$ANSPNS_Crest_Sagittal_CBCT1, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_CBCT1, 0) == 0,
  NA,
  replace_na(data_conti$ANSPNS_Crest_Sagittal_CBCT1, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_CBCT1, 0)
)
data_conti$ANSPNS_Crest_Sagittal_CBCT1[data_conti$ANSPNS_Crest_Sagittal_CBCT1 == 0] <- NA
data_conti$MENTAL_Crest_Sagittal_CBCT1[data_conti$MENTAL_Crest_Sagittal_CBCT1 == 0] <- NA

##############

data_conti$Height_sagittal_CBCT2 <- ifelse(
  replace_na(data_conti$ANSPNS_Crest_Sagittal_CBCT2, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_CBCT2, 0) == 0,
  NA,
  replace_na(data_conti$ANSPNS_Crest_Sagittal_CBCT2, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_CBCT2, 0)
)
data_conti$ANSPNS_Crest_Sagittal_CBCT2[data_conti$ANSPNS_Crest_Sagittal_CBCT2 == 0] <- NA
data_conti$MENTAL_Crest_Sagittal_CBCT2[data_conti$MENTAL_Crest_Sagittal_CBCT2 == 0] <- NA


##############

data_conti$Height_coronal_DIFF <- ifelse(
  replace_na(data_conti$ANSPNS_Crest_Coronal_DIFF, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_DIFF, 0) == 0,
  NA,
  replace_na(data_conti$ANSPNS_Crest_Coronal_DIFF, 0) + replace_na(data_conti$MENTAL_Crest_Coronal_DIFF, 0)
)
data_conti$ANSPNS_Crest_Coronal_DIFF[data_conti$ANSPNS_Crest_Coronal_DIFF == 0] <- NA
data_conti$MENTAL_Crest_Coronal_DIFF[data_conti$MENTAL_Crest_Coronal_DIFF == 0] <- NA

##############

data_conti$Height_sagittal_DIFF <- ifelse(
  replace_na(data_conti$ANSPNS_Crest_Sagittal_DIFF, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_DIFF, 0) == 0,
  NA,
  replace_na(data_conti$ANSPNS_Crest_Sagittal_DIFF, 0) + replace_na(data_conti$MENTAL_Crest_Sagittal_DIFF, 0)
)
data_conti$ANSPNS_Crest_Sagittal_DIFF[data_conti$ANSPNS_Crest_Sagittal_DIFF == 0] <- NA
data_conti$MENTAL_Crest_Sagittal_DIFF[data_conti$MENTAL_Crest_Sagittal_DIFF == 0] <- NA
...
```{r, message=F, warning=F}
cat("pvalue of 22 Y vs 152 N is:", pvalue_adjust(binom.test(c(22, 152), p = 0.5)$p.value), "\n")
...
```
* there are statistically significiantly different 
