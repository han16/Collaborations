...
```{r, echo=F, message=F, warning=F}
data_long_sqi %>% group_by(group, time) %>% identify_outliers(PBI)
```
no outliers 
...
```{r, echo=F, warning=F, message=F}
data_long_sqi %>% group_by(group, time) %>% shapiro_test(PBI)
```

Normal distribution is a reasonable by large p values 

```{r, echo=F, message=F, warning=F}
ggqqplot(data_long_sqi, "PBI", ggtheme=theme_bw())+
  facet_grid(time ~ group, labeller="label_both")
```
...
```{r, echo=F, message=F, warning=F}
data_long_fragmentation %>% group_by(group, time) %>% identify_outliers(PBI)
```
no outliers 
...
```{r, echo=F, warning=F, message=F}
data_long_fragmentation %>% group_by(group, time) %>% shapiro_test(PBI)
```

Normal distribution is a reasonable by large p values 

```{r, echo=F, message=F, warning=F}
ggqqplot(data_long_fragmentation, "PBI", ggtheme=theme_bw())+
  facet_grid(time ~ group, labeller="label_both")
```
