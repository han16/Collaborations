...
num_participants[2]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total>=3 & STOP.BANG.total<=4) %>%nrow 
average_sAHI[2]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total>=3 & STOP.BANG.total<=4) %>% select(sAHI) %>% pull, na.rm=T)
...
num_participants[4]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & Remarks.A..Gender=="M" ) %>%nrow 
average_sAHI[4]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & Remarks.A..Gender=="M") %>% select(sAHI) %>% pull, na.rm=T)

num_participants[5]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & BMI.kg.m2 >35) %>%nrow 
average_sAHI[5]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & BMI.kg.m2 >35) %>% select(sAHI) %>% pull, na.rm=T)
...
* don't see `neck` information in the data 
...
average_sAHI[1]=mean(data%>%filter(Patient.ID.Number>=40 &STOP.BANG.total>=0 & STOP.BANG.total<=2 & sAHI>=5) %>% select(sAHI) %>% pull, na.rm=T)

num_participants[2]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total>=3 & STOP.BANG.total<=4 & sAHI>=5) %>%nrow 
average_sAHI[2]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total>=3 & STOP.BANG.total<=4 & sAHI>=5) %>% select(sAHI) %>% pull, na.rm=T)
...
num_participants[4]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & Remarks.A..Gender=="M" & sAHI>=5 ) %>%nrow 
average_sAHI[4]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & Remarks.A..Gender=="M" & sAHI>=5 ) %>% select(sAHI) %>% pull, na.rm=T)

num_participants[5]=data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & BMI.kg.m2 >35 & sAHI>=5) %>%nrow 
average_sAHI[5]=mean(data%>%filter(Patient.ID.Number>=40 & STOP.BANG.total==2 & BMI.kg.m2 >35 & sAHI>=5) %>% select(sAHI) %>% pull, na.rm=T)
