...
for (i in 1:4)
{
  Cortisol_group1=data_Cortisol_update[which(data_Cortisol_update$treatment=="group1"),(i+2)]
  Cortisol_group2=data_Cortisol_update[which(data_Cortisol_update$treatment=="group2"),(i+2)]
  Cortisol_group3=data_Cortisol_update[which(data_Cortisol_update$treatment=="group3"),(i+2)]
...
######## convert into long format 
detach(data_Cortisol_update_long)
...
```
* average SQI: group 1: 54.82; group 2: 51.39; group 3: 42.88
