...
data_Cortisol_update=data.frame(id=Patient.ID.Number, treatment=trt, y0=data_Cortisol$Cortisol.1, y1=data_Cortisol$Cortisol.2, y2=data_Cortisol$Cortisol.3, y3=data_Cortisol$Cortisol.4)
...
#summary(model)
 ...
 anova(model)
```
* use normalized cortisol values and no overall group by time interaction due to p value of 0.0903
