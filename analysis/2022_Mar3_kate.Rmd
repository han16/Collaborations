...
## clinical successful cluster 


```{r, echo=F, message=F, warning=F, eval=F}
PBI_decrease_indi=data%>%filter(Average.PBI.Score.Pre.TX>2 & Average.PBI.Score.8.week <2 ) %>% select(Patient.ID.Number) %>% pull
PBI_increase_indi=setdiff(data$Patient.ID.Number, PBI_decrease_indi)
