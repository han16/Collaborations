---
title: "run final data analysis with updated subjects and numbers"
output:
...
## 2. Spearman's correlations for group 4
...
group4_maxilla_mandible=group4_data %>% filter(Jaw==1 | Jaw==2)
```
...
```{r, message=F, warning=F}
data_conti=as.matrix(group4_maxilla[,which(colnames(group4_mandible)%in%continuous_var)])
################ compute p values 
#data_conti[is.na(data_conti)] <- "0"
#cormat2=round(cor(data_conti, method="pearson", use = "na.or.complete"),2)
cormat2=matrix(nrow=ncol(data_conti), ncol=ncol(data_conti))
...
```{r, message=F, warning=F}
data_conti=as.matrix(group4_maxilla_mandible[,which(colnames(group4_maxilla_mandible)%in%continuous_var)])
################ compute p values 
#data_conti[is.na(data_conti)] <- "0"
#cormat2=round(cor(data_conti, method="pearson", use = "na.or.complete"),2)
cormat2=matrix(nrow=ncol(data_conti), ncol=ncol(data_conti))
...
## 3. Spearman's correlations for group 5 
...
group5_maxilla_mandible=group5_data %>% filter(Jaw==1 | Jaw==2)
```
...
```{r, message=F, warning=F}
data_conti=as.matrix(group5_maxilla[,which(colnames(group5_mandible)%in%continuous_var)])
################ compute p values 
#data_conti[is.na(data_conti)] <- "0"
#cormat2=round(cor(data_conti, method="pearson", use = "na.or.complete"),2)
cormat2=matrix(nrow=ncol(data_conti), ncol=ncol(data_conti))
...
```{r, message=F, warning=F}
data_conti=as.matrix(group5_maxilla_mandible[,which(colnames(group5_maxilla_mandible)%in%continuous_var)])
################ compute p values 
#data_conti[is.na(data_conti)] <- "0"
#cormat2=round(cor(data_conti, method="pearson", use = "na.or.complete"),2)
cormat2=matrix(nrow=ncol(data_conti), ncol=ncol(data_conti))
...
### 4.3 Sinus_pathology (updated: subjects that have Jaw=maxilla)
