...
ggplot(specialty_geo_data %>% filter(geo %in% c("R1", "Metro W-O-W")), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
 # ylim(c(0, 0.7))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
...
ggplot(specialty_geo_data %>% filter(geo %in% c("Urban", "R2/R1")), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
 # ylim(c(0, 0.7))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
