...
* there are 77 zip codes missing, i.e. not in Wisconsin zip code list, involving in 886 dentist, mainly because some code (46/77=59.7%) have sub-code like `53574-8881`, but Wisconsin zip code don't have sub-code 

* in dentist survey data, 891 zip codes are missing. 
...
fig=side_by_side_barplot(gender_geo_data, angle=30, num_size = 4, x_text_size=12, legend_text_size=12, title="Hygenist")
fig
...
fig=side_by_side_barplot(gender_geo_data, angle=30, num_size = 4, x_text_size=12, legend_text_size=12, title="Dentist_Survey")
fig
