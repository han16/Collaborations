...
annotate_figure(figure,
                top = text_grob("Hygienist", color = "red", face = "bold", size = 14),
...
figure=ggarrange(g1, g2, common.legend = TRUE, legend="none") 
annotate_figure(figure,
                top = text_grob("Dentist", color = "red", face = "bold", size = 14),
#                bottom = text_grob("Data source: \n ToothGrowth data set", color = "blue",
#                                   hjust = 1, x = 1, face = "italic", size = 10),
#                left = text_grob("Tooth length", color = "green", rot = 90),
#                right = "I'm done, thanks :-)!",
...
ggarrange(figures[[1]], figures[[2]], figures[[3]], figures[[4]], figures[[5]], figures[[6]], ncol=3)
