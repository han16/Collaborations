...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[1:2]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[1:2]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[3:4]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[3:4]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[5:6]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[5:6]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[7:8]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[7:8]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[9:10]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[9:10]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
...
ggplot(specialty_geo_data %>% filter(geo %in% region_code[11:12]), aes(x=spect, y=num, fill=spect)) +geom_bar(position = "dodge", stat="identity")+
  ylim(c(0, max(specialty_geo_data %>% filter(geo %in% region_code[11:12]) %>% select(num)%>% pull())+10))+
  facet_grid("geo")+
  ylab("n")+xlab("")+
  theme(legend.position="")+
  theme(axis.text.x = element_text(angle = 30, vjust = 0.5, size=10))+
