...
```{r, echo=F, message=F, warning=F}
side_by_side_barplot2=function(data, angle=0, num_size=3, x_text_size=10, legend_text_size=10, title)
{
  y_limit=max(data$n)*1.1
...
side_by_side_barplot2(practice_setting_combine, title="practice setting")
```
