...
for (i in 1:ncol(data_23_clean))
{
  ...
  pvalue2[i]=t.test(data_23_clean[, i], data_24_clean[, i], alternative ="less" )$p.value
  pvalue3[i]=t.test(data_23_clean[, i], data_24_clean[, i], alternative ="greater" )$p.value
} else {
  pvalue[i]="NA"
  pvalue2[i]="NA"
  pvalue3[i]="NA"
  ...
  data.frame(questions=paste("probe", seq(1:ncol(data_23_clean)), sep="_"), pvalue=pvalue_adjust(pvalue), pvalue2=pvalue_adjust(pvalue2), pvalue3=pvalue_adjust(pvalue3))%>%
