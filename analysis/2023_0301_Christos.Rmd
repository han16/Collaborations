...
study_data[7,]=c(as.numeric(data_24hour_full[20,3:5]), as.numeric(data_24hour_full[21,3:5]))
...
```{r, echo=F, message=F, warning=F}
##################### forest plot without Pereira
variable_include_index=c(2,3,4)
...
study_data[3,]=c(as.numeric(data_24hour_full[8,3:5]), as.numeric(data_24hour_full[9,3:5]))
study_data[4,]=c(as.numeric(data_24hour_full[10,3:5]), as.numeric(data_24hour_full[11,3:5]))

study_data[5,]=c(as.numeric(data_24hour_full[13,3:5]), as.numeric(data_24hour_full[14,3:5]))

study_data[6,]=c(as.numeric(data_24hour_full[16,3:5]), as.numeric(data_24hour_full[15,3:5]))

study_data[7,]=c(as.numeric(data_24hour_full[17,3:5]), as.numeric(data_24hour_full[18,3:5]))

study_data[8,]=c(as.numeric(data_24hour_full[19,3:5]), as.numeric(data_24hour_full[20,3:5]))

study_data[9,]=c(as.numeric(data_24hour_full[8,3:5]), as.numeric(data_24hour_full[10,3:5]))
...
study_data[5,]=c(as.numeric(data_3day_full[14,3:5]), as.numeric(data_3day_full[15,3:5]))

study_data[6,]=c(as.numeric(data_3day_full[8,3:5]), as.numeric(data_3day_full[10,3:5]))
