...
comparison=c("Pearlman, B._ibuprofen_vs_placebo", "Pereira, G._ibuprofen_vs_placebo", "Pilatti, G._dexamethasone 4mg_vs_placebo", "Pilatti, G._celecoxib 200mg_vs_placebo", "Santos, B._ibuprofen_vs_placebo",  "Santos, B._nimesilide_vs_placebo", "Steffens, J 2011_dexamethasone 4mg_vs_placebo", "Steffens, J 2011_dexamethasone 8mg_vs_placebo", "Steffens, J 2011 @_celecoxib 200mg_vs_placebo", "Steffens, J 2011 @_etoricoxib 120mg_vs_placebo", "Trombelli, L._ketorolac 10mg_vs_placebo", "Pilatti, G._dexamethasone 4mg_vs_celecoxib 200mg", "Santos, B._ibuprofen_vs_nimesilide", "Steffens, J 2011_dexamethasone 4mg_vs_dexamethasone 8mg", "Steffens, J 2011 @_celecoxib 200mg_vs_etoricoxib 120mg")

#study=c("Pearlman, B.", "Pereira, G.", "Pilatti, G.", "Pilatti, G.", "Santos, B.",  "Santos, B.", "Steffens, J 2011", "Steffens, J 2011", "Steffens, J 2011 @", "Steffens, J 2011 @", "Trombelli, L.", "Pilatti, G.", "Santos, B.", "Steffens, J 2011", "Steffens, J 2011 @")
...
treat1=c("ibuprofen", "ibuprofen", "dexamethasone 4mg", "celecoxib 200mg", "ibuprofen", "nimesilide", "dexamethasone 4mg", "dexamethasone 8mg", "celecoxib 200mg", "etoricoxib 120mg", "ketorolac 10mg", "dexamethasone 4mg", "ibuprofen", "dexamethasone 4mg", "celecoxib 200mg")
treat2=c(rep("placebo", 11), "celecoxib 200mg", "nimesilide", "dexamethasone 8mg", "etoricoxib 120mg")
...
comparison=c("Pereira, G._dexamethasone 4mg_vs_placebo",  
            ...
            "Pereira, G._dexamethasone 4mg_vs_celecoxib 200mg", 
...
treat1=c("dexamethasone 4mg", "celecoxib 200mg",  "dexamethasone 4mg", "dexamethasone 8mg", "celecoxib 200mg", "etoricoxib 120mg", "dexamethasone 8mg", "etoricoxib 120mg", "ketorolac 10mg", "dexamethasone 4mg", "dexamethasone 4mg", "celecoxib 200mg", "dexamethasone 8mg")
treat2=c(rep("placebo", 9), "celecoxib 200mg", "dexamethasone 8mg", "etoricoxib 120mg", "etoricoxib 120mg")

study=c( "Pereira, G.", "Pilatti, G.",  "Steffens, J 2011", "Steffens, J 2011", "Steffens, J 2011 @", "Steffens, J 2011 @", "Steffens, J 2010", "Steffens, J 2010", "Trombelli, L.", "Pereira, G.", "Steffens, J 2011", "Steffens, J 2011 @", "Steffens, J 2010")
...
study_data=matrix(nrow=16, ncol=6)
...
study_data[10,]=c(as.numeric(data_24hour_full[17,3:5]), as.numeric(data_24hour_full[15,3:5]))

study_data[11,]=c(as.numeric(data_24hour_full[18,3:5]), as.numeric(data_24hour_full[19,3:5]))

study_data[12,]=c(as.numeric(data_24hour_full[20,3:5]), as.numeric(data_24hour_full[21,3:5]))

study_data[13,]=c(as.numeric(data_24hour_full[4,3:5]), as.numeric(data_24hour_full[5,3:5]))
study_data[14,]=c(as.numeric(data_24hour_full[8,3:5]), as.numeric(data_24hour_full[10,3:5]))
study_data[15,]=c(as.numeric(data_24hour_full[12,3:5]), as.numeric(data_24hour_full[13,3:5]))
study_data[16,]=c(as.numeric(data_24hour_full[16,3:5]), as.numeric(data_24hour_full[17,3:5]))
