...
forest.meta(m.gen4, layout="JAMA", sortvar = TE, 
            prediction = FALSE, 
            print.tau2 = FALSE,
            fontsize=7,
            leftlabs = c("study", "SE", "g")) # sortvar = TE: sort studies by effect size 
...
forest.meta(m.gen5, layout="JAMA", sortvar = TE, 
            prediction = FALSE, 
            print.tau2 = FALSE,
            fontsize=7,
            leftlabs = c("study", "SE", "g")) # sortvar = TE: sort studies by effect size 
...
forest.meta(m.gen6, layout="JAMA", sortvar = TE, 
            prediction = FALSE, 
            print.tau2 = FALSE,
            fontsize=7,
            leftlabs = c("study", "SE", "g")) # sortvar = TE: sort studies by effect size 
...
forest.meta(m.gen_leave_one_out, layout="JAMA", sortvar = TE, 
            prediction = FALSE, 
            print.tau2 = FALSE,
            fontsize=7,
            leftlabs = c("study", "SE", "g")) # sortvar = TE: sort studies by effect size 
...
study_data[9,]=c(as.numeric(data_24hour_full[17,3:5]), as.numeric(data_24hour_full[15,3:5]))

study_data[10,]=c(as.numeric(data_24hour_full[18,3:5]), as.numeric(data_24hour_full[19,3:5]))

study_data[11,]=c(as.numeric(data_24hour_full[20,3:5]), as.numeric(data_24hour_full[21,3:5]))
