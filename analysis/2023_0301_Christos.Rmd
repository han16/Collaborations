...
##################### forest plot without Sanchez-Perez

m2 <- metacont(samplesize_exp, mean_exp, sd_exp, samplesize_contr, mean_contr, sd_contr,
  data = data_meta[-3,], sm = "SMD")
########### generate object for plot 

m.gen2 <- metagen(TE = m2$TE,
                 seTE =m2$seTE,
                 studlab = comparison[-3],
                 data = data_meta[-3,],
                 sm = "SMD",
                 fixed = FALSE,
                 random = TRUE,
...
##################### forest plot without Pereira
variable_include_index=c(2:3, 5:11)
...
forest.meta(m.gen3, layout="JAMA", sortvar = TE, 
            prediction = FALSE, 
            print.tau2 = FALSE,
            fontsize=6,
            leftlabs = c("study", "SE", "g")) # sortvar = TE: sort studies by effect size 
...
##################### forest plot without Pereira
variable_include_index=c(2:3, 5:8)
