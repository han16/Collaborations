...
glm_fit=glm(as.factor(Ext)~Upper.TSALD+Lower.TSALD+Skeletal.AP+Upper_lip+Lower_lip+Age+Sex+HISP, data = data3, family = "binomial") # response variable need to be factor 
cbind(exp(cbind(OR = coef(glm_fit), confint(glm_fit))), p_value=coef(summary(glm_fit))[,4])
